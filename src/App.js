...
function App() {
  ...
  function getProblemSpec(){
    ...
    download(JSON.stringify(problemSpec), "experiment2_problem_spec.json", "text/plain");
  }
  ...
  function submit() {
    ...
    if (notOK.length == 0) {
      ...
      download(JSON.stringify(answers), "Experiment2_"+userInfo["name"]+".json", "text/plain");
    }
